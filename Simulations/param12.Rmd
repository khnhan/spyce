...
b_xz_gauss_param12 = function(beta, x_a,
...
a_gauss_param12 = function(beta, x_a,
                           ...
                           sigma = 4, tau1 = 1, tau2 = 1,
                           tt = 20){
  MASS::ginv(L_xz_gauss_param12(beta, x_a,
                                alpha1_star, alpha2_star,
                                sigma, tau1, tau2,
                                tt)) %*%
    t(b_xz_gauss_param12(beta, x_a,
                         alpha1_star, alpha2_star,
                         sigma, tau1, tau2,
                         tt))
}
...
```{r}
pe_gauss_param12 = function(beta, y_data, w_data, delta_data,
                            x_a,
                            alpha1_star, alpha2_star,
                            sigma = 4, tau1 = 1, tau2 = 1,
                            tt = 20){
...
result_beta = foreach(k = 1:1000,
  ...
  {
    set.seed(k)
    get_beta_param_param12(k, n, d,
                           beta, alpha1, alpha2 = c(3, 0.12),
                           sigma = 4, tau1 = 1, tau2 = 1, tt = 20, m = 20)
  }

save(result_beta, file = 'Case_param12_low.Rdata')
...
save(result_beta, file = 'Case_param12_mid.Rdata')
...
save(result_beta, file = 'Case_param12_high.Rdata')
...
# Variance estimation
```{r}
estimated_variance_param12 = function(beta, y_data, w_data, delta_data,
                                      sigma = 4, tau1 = 1, tau2 = 1, tt = 20, m = 20,
                                      eps = 0.001){
  len_beta = length(beta)
  get_Sigma = function(beta, y_data, w_data, delta_data,
    ...
    for(i in 1:n){
      val[i,] = S_eff_gauss_param12(beta, y_data[i], w_data[i], delta_data[i],
                                    x_a, a0,
                                    alpha1_star,
                                    sigma, tau1, tau2, tt)
    }
...
# w_data = data_k$w_data
# delta_data = data_k$delta_data
# estimated_variance_param12(beta, y_data, w_data, delta_data,
#                            sigma = 4, tau1 = 1, tau2 = 1, tt = 20, m = 20,
#                            eps = 0.001)
```
...
variance = foreach(k = 1:1000,
  ...
  { 
    ...
    w_data = data_k$w_data
    delta_data = data_k$delta_data
    var_k = diag(estimated_variance_param12(
...
save(variance, file = 'Variance_param12_low.Rdata')
...
save(variance, file = 'Variance_param12_mid.Rdata')
...
save(variance, file = 'Variance_param12_high.Rdata')
