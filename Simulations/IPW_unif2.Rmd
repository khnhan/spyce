...
```{r}
pe_gauss_IPW_unif2 = function(beta, y_data, w_data, delta_data,
                              alpha2_star,
                              sigma = 4, tau1 = 1, tau2 = 1){
...
```{r}
get_beta_param_IPW_unif2 = function(k, n, d, 
                                    beta, alpha1, alpha2,
                                    sigma = 4, tau1 = 1, tau2 = 1){
  ...
  tic(k)
  set.seed(k)
  result = nleqslv::nleqslv(beta + rnorm(d + 1) * 0.1, pe_gauss_IPW_unif2, 
                            y_data = y_data,
                            w_data = w_data,
                            delta_data = delta_data,
...
# get_beta_param_IPW_unif2(1, n, d, 
...
result_beta = foreach(k = 1:1000,
  ...
  {
    set.seed(k)
    get_beta_param_IPW_unif2(k, n, d,
                             beta, alpha1, alpha2 = c(3, 0.12),
                             sigma = 4, tau1 = 1, tau2 = 1)
  }

save(result_beta, file = 'Case_IPW_unif2_low.Rdata')
...
save(result_beta, file = 'Case_IPW_unif2_mid.Rdata')
...
save(result_beta, file = 'Case_IPW_unif2_high.Rdata')
...
# Variance estimation
```{r}
estimated_variance_IPW_unif2 = function(beta, y_data, w_data, delta_data,
...
variance = foreach(k = 1:1000,
  ...
  { 
    ...
    w_data = data_k$w_data
    delta_data = data_k$delta_data
    var_k = diag(estimated_variance_IPW_unif2(
...
save(variance, file = 'Variance_IPW_unif2_low.Rdata')
...
save(variance, file = 'Variance_IPW_unif2_mid.Rdata')
...
save(variance, file = 'Variance_IPW_unif2_high.Rdata')
